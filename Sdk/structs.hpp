...
public:
    ...
    {
        *reinterpret_cast<float*>(uintptr_t(this) + (int)netvars::get().get_offset(table.c_str(), var.c_str())) = *val.c_str();
    }
...
public:
    ...
    bool IsGun();
    bool is_misc_weapon();
    bool CanShiftShot(int ticks_to_shift);
    bool is_rifle();
    bool is_smg();
    bool is_shotgun();
    bool is_pistol();
...
public:
    ...
    NETVAR(QAngle, m_aimPunchAngle2, crypt_str("CBasePlayer"), crypt_str("m_aimPunchAngle"));
    ...
    NETVAR(int32_t, m_iMoveState, crypt_str("DT_CSPlayer"), crypt_str("m_iMoveState"));
    ...
    NETVAR(int, m_flPlaybackRate, crypt_str("CBaseAnimating"), crypt_str("m_flPlaybackRate"));
    ...
    bool setup_local_bones(int matrix = 1);
