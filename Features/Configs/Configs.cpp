...
void C_ConfigManager::setup()
{
	...
	//Antiaim
	{
		...
		setup_item(&cfg::g_cfg.antiaim.flick, false, crypt_str("Antiaim.flick"));
		setup_item(&cfg::g_cfg.antiaim.flicktick, 0, crypt_str("Antiaim.flicktick"));
	...
	//Visuals
	{
		...
		setup_item(&cfg::g_cfg.misc.remove_third_person_animation, false, ("Misc.remove_thirdperson_animation"));
		...
		setup_item(&cfg::g_cfg.visuals.local_bullet_tracer, false, ("Esp.local_bullet_tracer"));
		setup_item(&cfg::g_cfg.visuals.local_bullet_tracer_color, Color(255, 255, 255), ("Esp.local_bullet_tracer_color"));
		...
		setup_item(&cfg::g_cfg.visuals.team_bullet_tracer, false, ("Esp.team_bullet_tracer"));
		setup_item(&cfg::g_cfg.visuals.team_bullet_tracer_color, Color(255, 255, 255), ("Esp.team_bullet_tracer_color"));
		setup_item(&cfg::g_cfg.visuals.local_bullet_tracers_type, 0, ("Esp.local_bullet_tracer_type"));
		setup_item(&cfg::g_cfg.visuals.enemy_bullet_tracers_type, 0, ("Esp.enemy_bullet_tracer_type"));
		setup_item(&cfg::g_cfg.visuals.team_bullet_tracers_type, 0, ("Esp.team_bullet_tracer_type"));
		setup_item(&cfg::g_cfg.visuals.preserve_killfeed, false, ("Esp.preserve_killfeed"));
		setup_item(&cfg::g_cfg.visuals.hitmarker_world, false, ("Esp.hit_marker_world"));
		setup_item(&cfg::g_cfg.visuals.hitmarker_screen, false, ("Esp.hit_marker_screen"));
		setup_item(&cfg::g_cfg.visuals.hitmarker_world_color, Color(255, 255, 255), ("Esp.hitmarker_world_color"));
		setup_item(&cfg::g_cfg.visuals.hitmarker_screen_color, Color(255, 255, 255), ("Esp.hitmarker_screen_color"));
		setup_item(&cfg::g_cfg.visuals.hiteffect, 2, ("Esp.hit_effect"));
		setup_item(&cfg::g_cfg.visuals.hit_effect_duration, 1.f, ("Esp.hit_effect_duration"));

		setup_item(&cfg::g_cfg.visuals.kill_effect, false, ("Esp.kill_effect"));
		setup_item(&cfg::g_cfg.visuals.kill_effect_duration, 1.f, ("Esp.kill_effect_duration"));
		...
		setup_item(&cfg::g_cfg.visuals.damage_marker_speed, 1, ("Esp.damage_marker_speed"));
		...
		setup_item(&cfg::g_cfg.visuals.spread_crosshair, false, ("Esp.spread_indicator"));
		setup_item(&cfg::g_cfg.visuals.spread_crosshair_color, Color(255, 255, 255), ("Esp.spread_indicator_color"));
		setup_item(&cfg::g_cfg.visuals.spread_crosshair_type, 0, ("Esp.spread_indicator_type"));
		...
		setup_item(&cfg::g_cfg.visuals.penetration_crosshair, 2, ("Esp.penetration_crosshair"));
