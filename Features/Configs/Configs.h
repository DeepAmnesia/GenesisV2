...
namespace cfg {
	...
	struct Config
	{
		...
		struct {
			...
			bool spread_crosshair;
			int spread_crosshair_type;
			Color spread_crosshair_color;

			std::vector <int> penetration_crosshair;
			...
			bool local_bullet_tracer;
			Color local_bullet_tracer_color;
			bool enemy_bullet_tracer;
			Color enemy_bullet_tracer_color;
			bool team_bullet_tracer;
			Color team_bullet_tracer_color;
			int local_bullet_tracers_type;
			int enemy_bullet_tracers_type;
			int team_bullet_tracers_type;
			bool preserve_killfeed;
			bool hitmarker_world;
			bool hitmarker_screen;
			Color hitmarker_world_color;
			Color hitmarker_screen_color;
		...
		struct {
			...
			bool remove_third_person_animation;
			bool ragdolls;
			bool bunnyhop;
			int airstrafe;
			bool crouch_in_air;
