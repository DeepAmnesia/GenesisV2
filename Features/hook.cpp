...
void hook::setup_hooks()
{
	...
	static auto set_viewmodel_offsets = (DWORD)(util::FindSignature(CLIENT_DLL, XorStr("55 8B EC 8B 45 08 F3 0F 7E 45")));
	static const auto draw_model = m_cvar()->FindVar(XorStr("r_drawmodelstatsoverlay"));
	static auto pGetViewmodelFOV = (DWORD)(util::FindSignature(CLIENT_DLL, XorStr("55 8B EC 8B 4D 04 83 EC 08 57")));
	...
	//hooks::original_set_viewmodel_offsets = (DWORD)DetourFunction((PBYTE)set_viewmodel_offsets, (PBYTE)hooks::hk_set_viewmodel_offsets);
	//hooks::original_viewmodel_fov = (DWORD)DetourFunction((PBYTE)pGetViewmodelFOV, (PBYTE)hooks::hkGetViewmodelFOV);
